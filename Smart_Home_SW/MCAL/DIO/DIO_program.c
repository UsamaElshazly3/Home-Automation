		...
		switch(Copy_u8PortId)
		{
			case DIO_u8_PORTA:
				switch(Copy_u8PinDirection)
				{
					...
					case DIO_u8_INPUT :CLR_BIT(DIO_u8_DDRA_REG, Copy_u8PortId);break;
				}
			break;
			case DIO_u8_PORTB:
				switch(Copy_u8PinDirection)
				{
					...
					case DIO_u8_INPUT :CLR_BIT(DIO_u8_DDRB_REG, Copy_u8PortId);break;
				}
			break;
			case DIO_u8_PORTC:
				switch(Copy_u8PinDirection)
				{
					...
					case DIO_u8_INPUT :CLR_BIT(DIO_u8_DDRC_REG, Copy_u8PortId);break;
				}
			break;
			case DIO_u8_PORTD:
				switch(Copy_u8PinDirection)
				{
					...
					case DIO_u8_INPUT :CLR_BIT(DIO_u8_DDRD_REG, Copy_u8PortId);break;
				}
			break;
		}
	}
